...
function basic_theme_customize_preview_js() {
	wp_enqueue_script( 'basic_theme-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
