...
if ( ! function_exists( 'basic_theme_setup' ) ) :
	...
	function basic_theme_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'basic_theme_custom_background_args', array(
...
function basic_theme_scripts() {
	wp_enqueue_style( 'basic_theme-style', get_stylesheet_uri() );

	wp_enqueue_script( 'basic_theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'basic_theme-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
